...
weight: 11
aliases:
- /docs/projects/templates/github/templates/required/contributing
---
...
[issue-labels]: /docs/projects/templates/github/issue-labels/
